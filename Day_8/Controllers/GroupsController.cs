...
namespace Day_8.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RoleName,Status")] Group @group)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RoleName,Status")] Group @group)
        {
            if (id != @group.Id)
            {
                return NotFound();
